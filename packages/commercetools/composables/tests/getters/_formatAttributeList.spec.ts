...
describe('[commercetools getters] internal utilities Getters', () => {
  const attributeList = [
  ...
  it('transforms custom value attribute fields to normalized "value" and copies "value" to "label" if it is empty', () => {
    ...
    expect(formatAttributeList(attributeList)).toEqual(normalizedAttributeList);
  });
});
